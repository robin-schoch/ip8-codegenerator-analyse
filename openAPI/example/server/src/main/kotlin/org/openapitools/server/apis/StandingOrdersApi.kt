...
import org.openapitools.server.models.StandingOrdersGet200Response
import org.openapitools.server.models.StandingorderSubmissionRequest
import org.openapitools.server.models.StandingorderSubmissionStatus

@KtorExperimentalLocationsAPI
fun Route.StandingOrdersApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    authenticate("OAuth2") {
    get<Paths.standingOrdersGet> {
        ...
        val exampleContentType = "application/json"
            val exampleContentString = """{
              ...
              "paymentList" : [ {
                ...
                "endDate" : "2018-04-13T00:00:00.000+00:00",
                "otherDetails" : {
                  "chargeBearer" : "SHAR",
                  "creditorAgent" : {
                ...
                "executionBreaks" : [ {
                  "validFromDate" : "2018-04-13T00:00:00.000+00:00",
                  "validToDate" : "2018-04-13T00:00:00.000+00:00"
                }, {
                  "validFromDate" : "2018-04-13T00:00:00.000+00:00",
                  "validToDate" : "2018-04-13T00:00:00.000+00:00"
                } ],
                "startDate" : "2018-04-13T00:00:00.000+00:00"
              }, {
                "debtorAccount" : {
                  "identification" : "CH9300762011623852957",
                  "type" : "IBAN"
    ...
    authenticate("OAuth2") {
    delete<Paths.standingOrdersSubmissionIdDelete> {
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()!!
    ...
    authenticate("OAuth2") {
    get<Paths.standingOrdersSubmissionIdGet> {
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()!!
    ...
    authenticate("OAuth2") {
    get<Paths.standingOrdersSubmissionIdStatusGet> {
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()!!
