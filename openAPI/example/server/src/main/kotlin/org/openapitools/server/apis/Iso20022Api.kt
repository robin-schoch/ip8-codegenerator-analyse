...
fun Route.Iso20022Api() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    authenticate("OAuth2") {
    post<Paths.iso20022PaymentsPost> {
    ...
    authenticate("OAuth2") {
    delete<Paths.iso20022PaymentsSubmissionIdDelete> {
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()!!
    ...
    authenticate("OAuth2") {
    get<Paths.iso20022PaymentsSubmissionIdGet> {
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()!!
    ...
    authenticate("OAuth2") {
    get<Paths.iso20022PaymentsSubmissionIdStatusGet> {
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()!!
