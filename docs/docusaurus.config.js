...
const config = {
    ...
    organizationName: 'imvs', // Usually your GitHub org/user name.
    projectName: 'Generischer Codegenerator für State-Event-Machines Kon-figurationen des State-Event-Editors von Swissframe', // Usually your repo name.
